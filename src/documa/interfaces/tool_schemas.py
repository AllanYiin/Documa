    ...
    descriptors = [
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "pdf_provider": {"type": "string", "enum": ["auto", "rust", "pymupdf"], "default": "auto"},
                    "office_provider": {"type": "string", "enum": ["auto", "rust", "python"], "default": "auto"},
                },
                "required": ["source"],
            },
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "pdf_provider": {"type": "string", "enum": ["auto", "rust", "pymupdf"], "default": "auto"},
                    "office_provider": {"type": "string", "enum": ["auto", "rust", "python"], "default": "auto"},
                    "keyword_provider": {"type": "string", "enum": ["lingxi", "ngram"], "default": "lingxi"},
                },
                "required": ["source"],
            },
            "outputSchema": {
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "mode": {"type": "string", "enum": ["readiness", "quality"], "default": "readiness"},
                    "gold_dir": {"type": "string", "default": "fixtures/pdf/gold"},
