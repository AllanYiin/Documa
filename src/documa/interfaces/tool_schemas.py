        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "max_tokens": {"type": ["integer", "null"], "minimum": 1, "description": "Truncate content to roughly this many tokens (CJK-aware estimate); the tighter of max_chars/max_tokens wins."},
                },
                "required": ["ir_path", "block_id"],
            },
            "outputSchema": {"type": "object", "properties": {"status": {"type": "string"}}},
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "max_response_tokens": {"type": ["integer", "null"], "minimum": 1, "description": "Hard ceiling on the estimated response size; lowest-ranked rows are dropped first and reported in budget.dropped_results."},
                },
