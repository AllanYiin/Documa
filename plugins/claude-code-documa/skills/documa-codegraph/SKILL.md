...
description: Use when the user asks Codex to locate code symbols, inspect imports or dependencies, trace callers/callees, find cycles, or assess repository change impact with source evidence. Do not use for runtime profiling, UI graph rendering, or security taint analysis.
license: MIT
metadata: {"language":"en","category":"code","integration":"mcp","short-description":"Evidence-bound repository code, dependency, call, and impact graph"}
---
