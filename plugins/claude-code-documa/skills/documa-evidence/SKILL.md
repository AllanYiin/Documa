---
description: Use Documa MCP tools for evidence-first document understanding. Use when a task asks Claude Code to read, search, summarize, compare, or answer from PDF, Office, HTML, email, notebook, Markdown, or Documa IR files.
---
